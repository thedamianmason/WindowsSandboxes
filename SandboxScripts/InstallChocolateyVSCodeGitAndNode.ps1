# Modified from https://github.com/AMIS-Services/code-cafe-20200504/blob/master/WindowsSandbox/InstallChocolateyVSCodeGitAndNode.ps1

# this script should be located on the Windows Host in directory C:\SandboxScripts or "..\..\WindowsSandboxes\SandboxScripts"
...
#    @("docker-cli"),    @("firefox"),    @("procexp"),    @("conemu"),    @("notepadplusplus"),    @("linqpad")
$Packages = @(
    @("git"),
    @("nodejs"),
